#!/usr/bin/env python3
"""Apply simple load analysis to __main__.py"""
...
if match:
    content = re.sub(pattern, new_print_summary + '\n\n', content, flags=re.DOTALL)
    print("✓ Replaced print_summary function")
else:
    print("✗ Could not find print_summary to replace")

# 저장
with open('llm_inference_simulator/__main__.py', 'w') as f:
    f.write(content)

print("✓ Successfully updated __main__.py")
